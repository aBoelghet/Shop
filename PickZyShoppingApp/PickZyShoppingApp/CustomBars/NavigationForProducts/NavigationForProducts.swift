...
@objc protocol NavigationForProductsDelegate:class {
...
@IBDesignable class NavigationForProducts: NibView {
    
    weak var delegate:NavigationForProductsDelegate?
    ...
    @IBAction func sizeClassBtnAction(_ sender: UIButton) {
        delegate?.sizeClassBtnPressed(sender: sender)
    }
    
    @IBAction func categoryMenuAction(_ sender: UIButton) {
        delegate?.categoryMenuAction()
    }

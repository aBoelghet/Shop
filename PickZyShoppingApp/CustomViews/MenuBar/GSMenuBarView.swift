...
//        headerView.guestUser_stackView.isHidden = true
        ...
        if imageLinkFromAPI != "" {
            ...
            headerView.profileImage.sd_setImage(with: URL(string: imageUrl), placeholderImage: #imageLiteral(resourceName: "placeHolderProfile_icon"), options: .progressiveLoad) { (image, error, cache_type, url) in

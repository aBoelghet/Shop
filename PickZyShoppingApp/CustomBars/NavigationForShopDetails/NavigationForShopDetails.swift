...
@objc protocol NavigationForShopDetailsDelegate:class {
    
    func leftBarBtnPressed(sender:UIButton)
    func rightBarBtnPressed(sender:UIButton)
}

@IBDesignable class NavigationForShopDetails: NibView {
    
    weak var delegate:NavigationForShopDetailsDelegate?
    
    @IBOutlet weak var leftBarBtn: UIButton!
    @IBOutlet weak var rightBarBtn: UIButton!
    @IBOutlet weak var titleLable: GSBaseLabel!
    @IBOutlet weak var subTitleLabel:GSBaseLabel!
    ...
    private func applyColors() {
        ...
        subTitleLabel.textColor = UIColor(hexString: defaultTheme.NAVIGATION_TITLE_COLOR)

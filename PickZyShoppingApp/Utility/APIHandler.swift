...
class APIHandler: NSObject {
    ...
    class func NetworkSetupRequestWithoutToken(method:HTTPMethod?,params: [String: AnyObject]?,urlString:String, withLoader:Bool, callback: @escaping (_ response: Data?, _ error: NSError?) -> Void) {
        setupNetworkRequestWith(method: method, params: params, urlString: urlString, headers: ["Content-Type":"application/json"] as HTTPHeaders, withLoader: withLoader, callback: callback)
    }
    ...
    class func NetworkSetupRequest(method:HTTPMethod?, params: [String: AnyObject]?,urlString:String,headers: HTTPHeaders, withLoader:Bool, callback: @escaping (_ response: Data?, _ error: NSError?) -> Void) {
        checkForRefreshTokenAndProceedForAPIWith(method: method ?? .post, params: params ?? nil, urlString: urlString, headers: headers, withLoader: withLoader, callback: callback)
    }
    
    // MARK: - Refresh Token
    
    private class func checkForRefreshTokenAndProceedForAPIWith(method:HTTPMethod?, params: [String: AnyObject]?,urlString:String,headers: HTTPHeaders, withLoader:Bool, callback: @escaping (_ response: Data?, _ error: NSError?) -> Void) {
        
        
        setupNetworkRequestWith(method: method ?? .post, params: params ?? nil, urlString: urlString, headers: headers , withLoader: withLoader, callback: callback)
    ...
    private class func setupNetworkRequestWith(method:HTTPMethod?, params: [String: AnyObject]?,urlString:String,headers: HTTPHeaders?, withLoader:Bool, callback: @escaping (_ response: Data?, _ error: NSError?) -> Void) {
    ...
    class private func failureResonseFormat(responseData: (AFDataResponse<Any>), result: (Any), statusCode: Int) -> NSError? {
    ...
    private class func multiPartRequestWith(method: HTTPMethod,multiPartItems:[Data],keyNames:[String],fileName:String,params: [String: Data]?,urlString:String,headers: HTTPHeaders, needToResignKeyboard:Bool, callback: @escaping (_ response: Data?, _ error: NSError?) -> Void) {
        ...
        }, to: urlString, usingThreshold: UInt64.init(), method: method, headers: headers) .downloadProgress { progress in
            print(progress)
    ...
    class func multiPartNetworkRequestWith(method: HTTPMethod,multiPartItems:[Data],keyNames:[String],fileName:String,params: [String: Data]?,urlString:String,headers: [String:String]?, needToResignKeyboard:Bool, callback: @escaping (_ response: Data?, _ error: NSError?) -> Void) {
        ...
        let accessToken = SharedPersistence.getValue(key: UserDefaultKeys.user.accessToken) as? String ?? ""
        let headers_updated:HTTPHeaders = ["Authorization": accessToken,
    ...
    class func refreshTokenAPI(topViewController:UIViewController, callback: @escaping ( _ error: NSError?) -> Void) {
        ...
        let headers: HTTPHeaders = ["Authorization":refreshToken,
                                    "Content-Type":"application/json"]
        
        //        isTokenRefreshing = true
        
        AF.request(refreshTokenUrl,
                   method: .post,
                   parameters: nil,
    ...
    class private func manageRefreshToken(responseData: (AFDataResponse<Any>)?) {

...
extension GSProfileAndSettingsViewController:UITableViewDelegate,UITableViewDataSource {
    ...
    private func profileCell(_ indexPath:IndexPath) -> UITableViewCell {
        ...
        cell.profile_imageView.sd_setImage(with: URL(string: imageUrl), placeholderImage: #imageLiteral(resourceName: "placeHolderProfile_icon"), options: .progressiveLoad) { (image, error, cache_type, url) in

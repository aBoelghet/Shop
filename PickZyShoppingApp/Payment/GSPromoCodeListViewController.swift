...
extension GSPromoCodeListViewController:UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.store_imgView.sd_setImage(with: URL(string: APIurl.baseURL + APIurl.subURL.viewPromoCodeStoreImage + (promoCodeAtIndex.storeIcon ?? "") + imgHeight), placeholderImage: #imageLiteral(resourceName: "blurImage"), options: .progressiveLoad, progress: nil) { (image, error, _ , _ ) in
